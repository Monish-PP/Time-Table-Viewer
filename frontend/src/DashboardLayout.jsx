  ...
  return (
            ...
            <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <div className="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <button id="manageResourcesBtn" className="btn btn-sm btn-outline-info d-flex align-items-center gap-1"
                        ...
                        <i className="fa-solid fa-database"></i> Manage Subjects / Classes / Venues
                    </button>
                    ...
                    <button id="manageStudentsBtn" className="btn btn-sm btn-outline-info d-flex align-items-center gap-1"
                        ...
                        <i className="fa-solid fa-users"></i> Add Students
                    </button>
                    ...
                    <button id="manageRosterBtn" className="btn btn-sm btn-indigo d-flex align-items-center gap-1  style-btn" style={{background: "var(--sece-indigo)"}} data-bs-toggle="modal" data-bs-target="#manageRosterModal">
                        <i className="fa-solid fa-users-gear"></i> Manage Students & Sections
                    </button>
        ...
        <div className="glass-panel p-3">
            <div className="row g-3 align-items-center">
                ...
                <div className="col-md-7">
                    <div className="d-flex align-items-center justify-content-md-end justify-content-start flex-wrap gap-3 text-light" style={{fontSize: "0.8rem"}}>
                        <div>
                            <strong className="text-muted">Batch:</strong> 
                            <span id="batchTextHeader" className="badge bg-primary" style={{outline: "none"}}>2024 - 2028</span>
                            <i id="batchEditIcon" className="fa-solid fa-pencil text-muted ms-1 d-none" style={{cursor: "pointer"}} title="Edit Batch"></i>
                        </div>
                        <div>
                            <strong className="text-muted">Semester:</strong> 
                            <span id="semTextHeader" className="badge bg-secondary" style={{outline: "none"}}>II Year / III Semester</span>
                            <i id="semEditIcon" className="fa-solid fa-pencil text-muted ms-1 d-none" style={{cursor: "pointer"}} title="Edit Semester"></i>
                        </div>
                        <div>
                            <strong className="text-muted">Academic Year:</strong> 
                            <span id="ayTextHeader" style={{outline: "none"}}>2026 - 2027</span>
                            <i id="ayEditIcon" className="fa-solid fa-pencil text-muted ms-1 d-none" style={{cursor: "pointer"}} title="Edit Academic Year"></i>
                        </div>
                        <div><strong className="text-muted">Class Strength:</strong> <span className="badge bg-success" id="classStrengthBadge">61 Students</span></div>
                        <div><strong className="text-muted">Class Advisor:</strong> <span className="text-warning">Ms.J.Keerthika, AP/CSE</span></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table className="tt-table">
                    <thead>
                        <tr>
                            ...
                            <th>1<br /><small className="text-dim">08.40 - 09.35</small></th>
                            <th>2<br /><small className="text-dim">09.35 - 10.25</small></th>
                            <th>3<br /><small className="text-dim">10.25 - 11.15</small></th>
                            <th className="text-warning" style={{width: "35px"}}>11.15-11.35</th>
                            <th>4<br /><small className="text-dim">11.35 - 12.25</small></th>
                            <th>5<br /><small className="text-dim">12.25 - 01.15</small></th>
                            <th className="text-warning" style={{width: "35px"}}>01.15-02.00</th>
                            <th className="text-info" style={{width: "80px"}}>02.00-02.30</th>
    ...
    <div className="modal fade" id="manageRosterModal" tabindex="-1">
        <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content bg-dark text-white border-secondary">
                <div className="modal-header border-secondary">
                    <h5 className="modal-title text-info fw-bold"><i className="fa-solid fa-users-gear me-2"></i> Manage Sections & Students Roster</h5>
                    <div>
                        <button type="button" className="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                </div>
                <div className="modal-body">
                    ...
                    <ul className="nav nav-tabs border-secondary mb-3" id="rosterTabs">
                        <li className="nav-item">
                            <button className="nav-link active text-info" data-bs-toggle="tab" data-bs-target="#tabStudents">Enrolled Students Roster</button>
                        </li>
                        <li className="nav-item" id="sectionsTabItem">
                            <button className="nav-link text-warning" data-bs-toggle="tab" data-bs-target="#tabAddSection">Add / Remove Sections</button>
                        </li>
                    </ul>
                    ...
                    <div className="tab-content">
                        ...
                        <div className="tab-pane fade show active" id="tabStudents">
                            <div className="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                                <h6 className="mb-0 text-light fw-bold">Section Roster (Class Strength: <span id="rosterCount">61</span>)</h6>
                        ...
                        <div className="tab-pane fade" id="tabAddSection">
    ...
    <div className="modal fade" id="editBatchSemModal" tabIndex="-1">
        <div className="modal-dialog modal-dialog-centered modal-sm">
            <div className="modal-content bg-dark text-white border-secondary">
                <div className="modal-header border-secondary">
                    <h5 className="modal-title text-primary"><i className="fa-solid fa-pen-to-square me-2"></i>Edit Class Info</h5>
                    <button type="button" className="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div className="modal-body">
                    <div className="mb-3">
                        <label className="form-label small text-muted">Batch Start Year</label>
                        <input type="number" id="modalBatchInput" className="form-control bg-dark text-white border-secondary" min="2020" max="3000" defaultValue="2024" />
                    </div>
                    <div className="mb-3">
                        <label className="form-label small text-muted">Year</label>
                        <select id="modalYearSelect" className="form-select bg-dark text-white border-secondary">
                    ...
                    <div className="mb-3">
                        ...
                        <select id="modalSemSelect" className="form-select bg-dark text-white border-secondary">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" id="modalAyInput" className="form-control bg-dark text-white border-secondary" defaultValue="2024 - 2025" />
                    </div>
                    <button className="btn btn-primary w-100 fw-bold" type="button" onClick={() => window.saveBatchSemInfo()}>Save Changes</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div className="modal-content bg-dark text-white border-secondary">
                ...
                <div className="modal-body">
                    ...
                    <ul className="nav nav-tabs border-secondary mb-3">
                        ...
                        <li className="nav-item"><button className="nav-link text-warning" data-bs-toggle="tab" data-bs-target="#resourceClasses">Classes</button></li>
                        <li className="nav-item"><button className="nav-link text-success" data-bs-toggle="tab" data-bs-target="#resourceVenues">Venues</button></li>
                    </ul>
                    <div className="tab-content">
                        <div className="tab-pane fade show active" id="resourceSubjects"><h6 className="text-info fw-bold border-bottom border-secondary pb-2">Manage Subjects — Subject Code, Name, Faculty, Category & Default Venue</h6>
                            <form id="addSubjectForm" onSubmit={(event) => window.handleAddSubject(event)}  className="row g-2 mb-3">
                                <div className="col-md-3"><input id="newSubjectShort" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Short name e.g. OS" required /></div>
                                <div className="col-md-3"><input id="newSubjectCode" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Course code" required /></div>
                                <div className="col-md-6"><input id="newSubjectTitle" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Subject title" required /></div>
                                <div className="col-md-6"><input id="newSubjectFaculty" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Faculty incharge" required /></div>
                                <div className="col-md-3">
                                    <select id="newSubjectCategory" className="form-select form-select-sm bg-dark text-white border-secondary">
                                        <option value="cat-theory">Theory</option>
                                        <option value="cat-lab">Lab</option>
                                        <option value="cat-alt">Professional / Placement</option>
                                        <option value="cat-project">Project / COE</option>
                                    </select>
                                </div>
                                <div className="col-md-3"><button className="btn btn-sm btn-info w-100" type="submit"><i className="fa-solid fa-plus me-1"></i>Add Subject</button></div>
                            </form>
                            <div className="table-responsive"><table className="table table-dark table-striped table-sm"><thead><tr><th>Short</th><th>Code</th><th>Title</th><th>Faculty</th><th>Action</th></tr></thead><tbody id="adminSubjectsList"></tbody></table></div>
                        </div>
                        <div className="tab-pane fade" id="resourceClasses"><h6 className="text-warning fw-bold border-bottom border-secondary pb-2">Manage Classes — Department, Class/Section, Classroom & Block</h6>
                            <form id="adminClassForm" onSubmit={(event) => window.handleAdminAddClass(event)}  className="row g-2 mb-3">
                                <div className="col-md-3"><input id="adminClassDept" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Department" required /></div>
                                <div className="col-md-5"><input id="adminClassName" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Class / Section e.g. II CSE D" required /></div>
                                <div className="col-md-2"><input id="adminClassRoom" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Classroom" required /></div>
                                <div className="col-md-2"><button className="btn btn-sm btn-warning w-100" type="submit"><i className="fa-solid fa-plus me-1"></i>Add</button></div>
                            </form>
                            <div className="list-group" id="adminClassesList"></div>
                        </div>
                        <div className="tab-pane fade" id="resourceVenues"><h6 className="text-success fw-bold border-bottom border-secondary pb-2">Manage Venues — Venue Name, Type, Block & Capacity</h6>
                            <form id="adminVenueForm" onSubmit={(event) => window.handleAddVenue(event)}  className="row g-2 mb-3">
                                <div className="col-md-4"><input id="newVenueName" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Venue name" required /></div>
                                <div className="col-md-3"><input id="newVenueType" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Type (Class/Lab)" /></div>
                                <div className="col-md-2"><input id="newVenueBlock" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Block" /></div>
                                <div className="col-md-1"><input id="newVenueCapacity" type="number" min="1" className="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Cap." /></div>
                                <div className="col-md-2"><button className="btn btn-sm btn-success w-100" type="submit"><i className="fa-solid fa-plus me-1"></i>Add Venue</button></div>
                            </form>
...
<script src="/js/theme.js"></script>
    ...
    <div className="modal fade" id="studentDetailsOnlyModal" tabindex="-1">
        <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content bg-dark text-white border-secondary">
                <div className="modal-header border-secondary">
                    <h5 className="modal-title text-info fw-bold"><i className="fa-solid fa-clipboard-list me-2"></i>Full Student Details</h5>
                    <div>
                        <button type="button" className="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                </div>
                <div className="modal-body">
                    <div className="alert alert-info py-2 small">This view is restricted to Admin and Class Advisor only. It contains sensitive student login details.</div>
                    <div className="table-responsive">
                        <table className="table table-dark table-striped table-hover align-middle small">
